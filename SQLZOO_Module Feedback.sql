...
2)SELECT CAM_SMO.MOD_CODE,INS_MOD.MOD_NAME
 ...
 3)SELECT CAM_SMO.MOD_CODE, INS_MOD.MOD_NAME,
...
4)SELECT INS_RES.QUE_CODE, QUE_TEXT,CAT_NAME,
...
5)SELECT MOD_CODE,RES_VALU,COUNT(1)
  FROM INS_RES 
WHERE INS_RES.MOD_CODE='SET08108'
AND PSL_CODE='TR1'
AND AYR_CODE='2016/7'
AND INS_RES.QUE_CODE='4.1'
GROUP BY INS_RES.MOD_CODE,RES_VALU
